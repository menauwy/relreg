#!/bin/bash
#SBATCH --job-name=segenc-wikisum-cpu
...
NAME=q2id_8_512_strided_wikisum_cpu
NUM_RUNS=5
START=1
...
do
 CUDA_VISIBLE_DEVICES="" python -u ../train.py \
  ...
  --model_name_or_path /home/wangym/data1/model/bart-wikisum/export/share/jvig/convsumm/bart-wikisum \
