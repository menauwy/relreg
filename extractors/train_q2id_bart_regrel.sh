#!/bin/bash
#SBATCH --job-name=relreg_bart_cpu
...
RELREG_OUTPUT_DIR='/home/wangym/data1/output-relreg-utt'
PATH_TO_CHECKPOINT='facebook/bart-large'
OUTPUT='/home/wangym/data1/output/relreg'

NAME=relreg-single-q2id-128-bart-large
NUM_RUNS=5
START=1
